...
class TinyMCE extends React.Component {
    ...
    render() {
        return this.props.config.inline ?
            React.createElement('div', {id: this.id, className: this.props.className, dangerouslySetInnerHTML:{__html: this.props.content}}) :
            React.createElement('textarea', {id: this.id, className: this.props.className, name: this.props.name, defaultValue: this.props.content});
    }
